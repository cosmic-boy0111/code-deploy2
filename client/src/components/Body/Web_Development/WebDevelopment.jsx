...
import logo from '../../../images/icon/layers.png'
import web from '../../../images/assets/WebDevelopment.jpg'
...
const WebDevelopment = () => {
  ...
  return (
    <>
        <TechHeader logo={logo} bg={web} text={"Web Development"}/>
        {/* <div className='code_container'> */}
    
        <Box sx={{ flexGrow: 1 }} >
        <Grid container spacing={{ xs: 4, md: 4 }} columns={{ xs: 8, sm: 8, md: 16 }}>
            {Array.from(Array(webRoutes.length)).map((_, index) => (

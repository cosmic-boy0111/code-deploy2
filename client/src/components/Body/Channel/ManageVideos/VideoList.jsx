...
export default function VideoTable({ rows , setRows }) {
    ...
    const {channelVideos, setChannelVideos} = React.useContext(ChannelContext);
                        ...
                        <TableBody>
                            {rows
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        <>
                                            <VideoTableRow row={row} setRows={setRows} handleClick={handleClick} isItemSelected={isItemSelected} labelId={labelId} />
                                        </>
                                    );
                                })
                                : null}

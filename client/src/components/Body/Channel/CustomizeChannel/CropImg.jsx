...
export default function ScrollDialog({
  ...
  const {channelImg, setChannelImg} = useContext(ChannelContext)
  ...
  const getCroppedImg = async () => {
    ...
    canvas.height = scaleY * crop.height * pixelRatio ; 
      ...
      // file = JSON.stringify(file)
        ...
        // const response = await fetch(`/updateChannelImg/${channel_id}`, {
        //   method: 'POST',
        //   body: formData
        // });
        await axios.post(`/updateChannelImg/${channel_id}`, formData, {
        }).then(res => {
            console.log(res);
